...
const uint16_t lead_notes[] = {
  ...
  _E6, _E6, _E6, _E6, _E6, _E6, _DS6, _E6, _G6, _F6, _E6, _F6, _AS0, _F6, _E6, _DS6, _E6, _A5, _C6, _B5, 0
...
uint8_t lead_times[] = {
  ...
  1, 1, 1, 1, 1, 1, 1, 1, 2, 1, 1, 2, 2, 2, 1, 1, 2, 2, 4, 2, 0
...
const uint16_t bass_notes[] = {
  ...
  _C6, _C6, _C6, _C6, _C6, _C6, _B5, _C6, _DS6, _CS6, _C6, _CS6, _AS5, _CS6, _C6, _B5, _C6, _E5, _E5, _E5, 0
...
void setup(){
  Serial.begin(250000);
  while (!Serial);
  Serial.print("Loading lead notes into EEPROM at ");
  Serial.println(ADDRESS_OFFSET);
  index = 0;
  for(a=ADDRESS_OFFSET; a<sizeof(lead_notes)+ADDRESS_OFFSET; a+=sizeof(lead_notes[0])){
    EEPROMWriteInt(a, lead_notes[index]);
    Serial.print(a);
    Serial.print(": ");
    Serial.print(lead_notes[index]);
    Serial.print("=");
    Serial.print(EEPROMReadInt(a));
    Serial.print(", ");
    index++;
  }
  ADDRESS_OFFSET = a;
  Serial.println("STOP");
  Serial.print("Loading lead times into EEPROM at ");
  Serial.println(ADDRESS_OFFSET);
  index = 0;
  for(a=ADDRESS_OFFSET; a<sizeof(lead_times)+ADDRESS_OFFSET; a+=sizeof(lead_times[0])){
    EEPROM.write(a, lead_times[index]);
    Serial.print(a);
    Serial.print(": ");
    Serial.print(lead_times[index]);
    Serial.print("=");
  ...
  ADDRESS_OFFSET = a;
  Serial.println("STOP");
  Serial.print("Loading bass notes into EEPROM at ");
  Serial.println(ADDRESS_OFFSET);
  index = 0;
  for(a=ADDRESS_OFFSET; a<sizeof(bass_notes)+ADDRESS_OFFSET; a+=sizeof(bass_notes[0])){
    EEPROMWriteInt(a, bass_notes[index]);
    Serial.print(a);
    Serial.print(": ");
    Serial.print(bass_notes[index]);
    Serial.print("=");
    Serial.print(EEPROMReadInt(a));
    Serial.print(", ");
    index++;
  ...
  ADDRESS_OFFSET = a;
  Serial.println("STOP");
  Serial.print("Loading bass times into EEPROM at ");
  Serial.println(ADDRESS_OFFSET);
  index = 0;
  for(a=ADDRESS_OFFSET; a<sizeof(bass_times)+ADDRESS_OFFSET; a+=sizeof(bass_times[0])){
    EEPROMWriteInt(a, bass_times[index]);
    Serial.print(a);
    Serial.print(": ");
    Serial.print(bass_times[index]);
    Serial.print("=");
    Serial.print(EEPROM.read(a));
    Serial.print(", ");
    index++;
